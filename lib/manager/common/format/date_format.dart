...
String getDateFormat(DateTime dateTime,
  ...
  String month = formatDate(dateTime, ['mm']).toString();
  String year = formatDate(dateTime, ['yyyy']).toString();
  String hour = formatDate(dateTime, ['HH']).toString();
  String min = formatDate(dateTime, ['nn']).toString();
  //M
